<?php 
    ...
    //Ejecutar codigo después que el usuario envie el formulario
    if ($_SERVER['REQUEST_METHOD'] === 'POST')  {
        ...
        // Revisar que el arreglo de errores esté vacio (Que no tengamos errores)
        if(empty($errores)) {
        // Crear Carpeta
        ...
        /* Subida de archivos */
            ...
            habitaciones = ${habitaciones}, wc = ${wc}, vendedorId = ${vendedorId} WHERE id = ${id} ";
